"""
Pull The Rope game handler — real-time simultaneous tapping.

Both players tap to pull the rope toward their side.
Win by pulling the knot past the threshold or by having more taps when
the 60-second timer expires. P1 is authoritative for timer-based wins.
...
class PullTheRopeHandler(BaseGameHandler):
    game_id = "pulltherope"
    game_name = "Pull The Rope"
    game_mode = "real_time"
    min_players = 2
    max_players = 2
