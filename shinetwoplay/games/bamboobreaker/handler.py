"""
Bamboo Breaker game handler — real-time 2-player tile-breaking panda battle.

P1-authoritative: client runs physics, server tracks scores/rounds.
"""
...
class BambooHandler(BaseGameHandler):
    game_id = "bamboobreaker"
    game_name = "Bamboo Breaker"
    game_mode = "real_time"
    min_players = 2
    max_players = 2
