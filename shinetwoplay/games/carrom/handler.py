"""
Carrom game handler — turn-based carrom board game.

Physics runs entirely on the client. The server tracks:
  • player assignments (P1 = black, P2 = white)
  • scores
  • whose turn it is
...
class CarromHandler(BaseGameHandler):
    game_id = "carrom"
    game_name = "Carrom"
